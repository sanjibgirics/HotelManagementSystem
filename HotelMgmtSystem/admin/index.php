...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">MAYFAIR HOMEPAGE</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM admin WHERE aid = '$myusername' and password = '$mypassword'";
