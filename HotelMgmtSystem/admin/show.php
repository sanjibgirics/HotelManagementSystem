...
@page { margin: 0; }
	...
	$sql ="select * from room,room_type,reservation r1,registration r2 where rsid='$pid' and gid=uid and rmid=rid and rmtype=rtid ";
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$phone = $row['mobile'];
		$room_type = $row['descripition'];
		//$Bed_type = $row['Bed'];
		//$Noof_room = $row['Nroom'];
		$meal_type = $row['Meal'];
		$cin_date = $row['date_in'];
		$cout_date = $row['date_out'];
		$nodays = $row['days'];
		$N = $row['price'];
		$amount = $row['amount'];
		$per=$row['price'];
	...
	?>
		<header>
			...
			<address >
				<p>MAYFAIR HOTEL,</p>
				<p>Near Nit Calicut,<br>Kerala,<br>India.</p>
				<p>(+91) 8984679161</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span >Per Day Price</span></th>
						<th><span >No of Days</span></th>
						<th><span >Room Amount</span></th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td><span ><?php echo $N*$nodays; ?> </span></td>
			...
			<table class="inventory">
				...
				<h1 class="amount">@      @          @        @ Final Amount :-<?php echo $N*$nodays+$amount; ?></h1>
		<aside>
						<h1>------------------------------------------------------</h1>
			...
			<div >
				<p align="center">Email :- info@mayfair.com || Web :- www.mayfair.com || Phone :- +91 89 8467 91 61 </p>
			</div>
		</aside>
	</body>
</html>
